...
; v1.7.5 wave 2: procedural set retired in favour of the Juggernaut
; essentials — clean the WebP variants too so they don't linger.
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\cyberpunk-skyline.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\cyberpunk-skyline.thumb.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\neon-grid.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\neon-grid.thumb.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\anime-window.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\anime-window.thumb.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\geometric-panels.webp"
Type: files; Name: "{localappdata}\SignalRGBWallpaper\library\geometric-panels.thumb.webp"
